...
## 2026-05-22 - [Refactor] Inspector UI Decomposition
**Discovery:** `src/dev/ui/inspector.js` had become a "God Class" (460 lines), managing UI orchestration, object property inspection, global world settings, and low-level DOM widget creation. This mixing of layers made it difficult to maintain and test individual components.
**Action:** [Separation of Concerns] Decomposed `Inspector` into a coordinator class and two specialized components: `PropertiesInspector` and `WorldInspector`. Extracted reusable UI widgets into `src/dev/ui/widgets/inputs.js`. This strictly separates the responsibilities of "Orchestration", "Object Inspection", "World Control", and "UI Rendering".
