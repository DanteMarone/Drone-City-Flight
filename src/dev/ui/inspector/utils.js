...
export function createScaleInput(vec, getLockScale, setLockScale, onUpdate) {
    const label = 'Scale';
    const row = document.createElement('div');
    row.className = 'dev-prop-row';
