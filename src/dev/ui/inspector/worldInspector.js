...
export class WorldInspector {
    ...
    render(container) {
        ...
        if (this.devMode.app.world.timeCycle) {
            ...
            // Time Speed
            const speedRow = createNumberInput('Speed', tc.speed, (v) => tc.speed = v, this.idCounter++);
        ...
        if (this.devMode.app.world.wind) {
            ...
            envGroup.appendChild(createNumberInput('Speed', wind.speed, (v) => wind.speed = v, this.idCounter++));
            envGroup.appendChild(createNumberInput('Direction', wind.direction, (v) => wind.direction = v, this.idCounter++));
        }
