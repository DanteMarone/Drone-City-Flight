import { createNumberInput, createCheckbox } from './utils.js';

export class InspectorWorldTab {
    constructor(devMode) {
    ...
    render(content) {
        ...
        // Time of Day
        if (this.devMode.app.world && this.devMode.app.world.timeCycle) {
            ...
            const sliderId = `insp-time-${Math.floor(Math.random() * 10000)}`;
        ...
        // Wind
        if (this.devMode.app.world && this.devMode.app.world.wind) {
        ...
        if (this.devMode.app.world && this.devMode.app.world.batteryDrain !== undefined) {
