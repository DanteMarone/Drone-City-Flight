        ...
        div.innerHTML = `
            ...
            <div style="display:flex; flex-direction:column; gap:5px; font-size:0.9em;">
                <div style="background:#222; padding:5px;">
                    ...
                    <input type="range" id="dev-time-slider" min="0" max="24" step="0.1" value="12" style="width:100%" aria-label="Time of Day">
            ...
            <hr style="width:100%">
            <h3>Objects</h3>
            <input type="text" id="dev-palette-search" placeholder="Search objects..." aria-label="Filter objects" style="width: 100%; box-sizing: border-box; margin-bottom: 5px; background: #222; color: white; border: 1px solid #444; padding: 5px;">
