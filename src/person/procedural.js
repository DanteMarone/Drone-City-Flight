...
export function createRandomAppearance() {
...
function _applyShadows(mesh) {
    mesh.castShadow = true;
    mesh.receiveShadow = true;
}

function _createHeadGeometry(headStyle) {
...
function _addHair(headGroup, headStyle, hairMat) {
...
export function buildPersonMesh(appearance, parentGroup) {
    const {
        skinTone,
        hairColor,
        clothingPrimary,
    ...
    const headGeometry = _createHeadGeometry(headStyle);
    ...
    _applyShadows(eyeLeft);
    _applyShadows(eyeRight);
...
function _buildArms({ skinMat, clothSecondaryMat, bodyStyle, parentGroup }) {
...
function _buildLegs({ skinMat, clothSecondaryMat, accentMat, bodyStyle, parentGroup }) {
